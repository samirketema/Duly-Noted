<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminNoteSearchResult.aspx.cs" Inherits="SearchResult" %>
    ...
    <div class="container">
        <div class="bs-docs-header" id="content">
          <div class="container">            
                ...
                <br />
                <asp:Button ID="btnReturn" Text="Back to Admin Page" runat="server" OnClick="btnReturn_Click" />
                </div>
